...
let prediction = "";
var model = undefined;
const secondButton = document.getElementById("speakButton");
  ...
  model.detect(video).then(function (predictions) {
    ...
    for (let n = 0; n < predictions.length; n++) {
      ...
      if (predictions[n].score > 0.66) {
        prediction = predictions[n].class;
        const p = document.createElement("p");
        p.innerText =
          predictions[n].class +
          " - with " +
...
const speakIt = document.getElementById("speakButton");
speakIt.addEventListener("click", speak);
...
// shareButton.addEventListener("click", screenshot);
// function screenshot() {
//   // html2canvas(document.querySelector("#screen")).then((canvas) => {
//   //   document.body.appendChild(canvas);
//   // });
//   html2canvas(document.getElementById("liveView"), {
//     allowTaint: true,
//     useCORS: true,
//   })
...
//       overlayDiv.innerHTML = `<img src=${image} />`;
//     })
//     .catch((e) => {
//       // Handle errors
//       console.log(e);
